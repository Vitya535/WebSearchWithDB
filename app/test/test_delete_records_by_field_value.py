...
class DeleteRecordByFieldValueTestCase(CommonSettingsForTestCase):
    """Класс модульных тестов удаления записей
    по определенным параметрам из истории поиска и просмотра"""
    ...
    def test_delete_watch_history_record_by_doc_name(self):
        ...
        self.assertEqual(len(watch_history_records),
    ...
    def test_delete_search_history_record_by_search_query(self):
        ...
        self.assertEqual(len(search_history_records),
                         PROJECT_CONSTANTS.RECORDS_COUNT_SEARCH_HISTORY - 1)
